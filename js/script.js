	(function (doc, win, docEl) {
		...
		if (hash) {
			...
			log('<h2>OS</h2> ' + hash[1]);
			log('<h2>Browser</h2> ' + hash[2], 'earth');
			log('<h2>Browserversion</h2> ' + hash[3]);
			...
			log('<h2>Browser</h2> ' + uaDetails.browser.name, 'earth');
			log('<h2>Browserversion</h2> ' + uaDetails.browser.major + ' (' + uaDetails.browser.version + ')');
			...
			doc.location.hash = ':' + uaDetails.os.name + ' (' + uaDetails.os.version + ')' + ':' + uaDetails.browser.name + ':' + uaDetails.browser.major + ' (' + uaDetails.browser.version + ')' + ':' + uaDetails.engine.name + ':' + docW + ' x ' + docH + ':' + w + ' x ' + h + ':' + color + ':' + getFlashVersion().split(',').shift() + ':' + cookiesEnabled();
